        ...
        migrations.RunSQL(
            sql=[
                ...
                CREATE TABLE IF NOT EXISTS daily_rejects (
                  id bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
                  dalytran_id varchar(16) NOT NULL UNIQUE,
                ...
                CREATE TABLE IF NOT EXISTS pending_auth_detail (
                  ...
                  CONSTRAINT pending_auth_detail_pk UNIQUE (card_num, transaction_id)
                )
                """,
                """
                CREATE INDEX IF NOT EXISTS pending_auth_detail_auth_ts_idx
                ON pending_auth_detail (auth_date, auth_time)
                """,
                """
                CREATE INDEX IF NOT EXISTS pending_auth_detail_card_transaction_idx
                ON pending_auth_detail (card_num, transaction_id)
                """,
                """
